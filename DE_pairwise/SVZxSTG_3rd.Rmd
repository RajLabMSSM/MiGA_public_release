...
samples_reg1 = as.character(metadata$donor_tissue[metadata$tissue %in% "SVZ"])
...
res_dream <- data.frame(topTable(fitmm, coef='tissueSVZ', 
...
write.table(res_name, file = paste0(work_plots, "SVZxSTG_dream_3rd.txt"), quote = F, sep = "\t")

```

### Directionality 
LogFC > 0 is up in SVZ from **Dream**. 
