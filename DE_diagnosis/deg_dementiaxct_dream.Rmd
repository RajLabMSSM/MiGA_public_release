...
samples_case = as.character(metadata$donor_tissue[metadata$main_diagnosis %in% "Dementia"])
...
res_dream <- data.frame(topTable(fitmm, coef='main_diagnosisDementia', 
...
write.table(res_name, file = paste0(work_plots, "dementiaxCT_dream_3rd.txt"), quote = F, sep = "\t")
