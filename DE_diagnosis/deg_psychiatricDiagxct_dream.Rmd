...
subtitle: "Psychiatric Diagnosis x CT"
author:  |
...
register(MulticoreParam(workers = 20), default = TRUE)
```
...
samples_case = as.character(metadata$donor_tissue[metadata$main_diagnosis %in% "Psychiatric diagnosis"])
...
write.table(res_name, file = paste0(work_plots, "psychiatric_diagnosisxCT_dream.txt"), quote = F, sep = "\t")
